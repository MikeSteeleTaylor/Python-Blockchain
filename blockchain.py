...
class Blockchain:
    ...
    def load_data(self):
        """ Initialise blockchain + open transactions data from a file"""
        try:
    ...
    def mine_block(self):
        ...
        # Copy transactions instead of
        # manipulating the original open_transactions
            ...
            try:
                ...
                node_chain = [Block(block['index'], block['previous_hash'],
                              [Transaction(tx['sender'], tx['recipient'],
                               tx['signature'], tx['amount']) for
                              tx in block['transactions']], block['proof'],
